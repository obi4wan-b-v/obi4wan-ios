...
///
- (nonnull instancetype)initWithAppGuid:(NSString * _Nonnull)appGuid enableLauncher:(BOOL)enableLauncher userGuid:(NSString * _Nullable)userGuid externalConfiguration:(ExternalChatConfigurationModel * _Nullable)externalConfiguration OBJC_DESIGNATED_INITIALIZER;
...
///
- (void)restartChatWithUserGuid:(NSString * _Nullable)userGuid;
